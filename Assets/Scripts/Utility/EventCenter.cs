...
public enum EventType
{
    ...
    OnLastWave,
    OnNextWave,
    OnCameraMoveLeftFinish,
    OnCameraMoveRightFinish,
    OnFirstZombieAppear,
}
...
public class EventCenter : Singleton<EventCenter>
{
    ...
    public void RegisterObserverAutoRemove(EventType type, UnityAction action)
    {
        if (EventsDic.ContainsKey(type))
        {
            foreach (IEventInfo info in EventsDic[type])
    ...
    public void NotisfyObserverAutoRemove(EventType type)
    {
        if (EventsDic.ContainsKey(type))
        {
            foreach (IEventInfo info in EventsDic[type])
